...
/**
 * enqueue_item_4 - An item to a queue is added.
 * @queue_h: Points to the head of the queue.
 * @queue_t: Points to the tail of the queue.
 * @n: Points to the size value of the queue.
...
/**
 * dequeue_item_4 - An item from a queue is removed.
 * @queue_h: Pointer to the head of the queue.
 * @queue_t: Points to the tail of the queue.
 * @n: Points to the size value of the queue.
 ...
 * @root: The actual root of the max binary heap tree.
 * Return: Pointer to the last level order node, else NULL.
 */
...
/**
 * swap_tree_node_with_parent_1 - Swaps a node with its parent.
 * @node: pointer to the node's address.
...
/**
 * heap_extract - The root node is extracted
 * @root: Pointer to the root node address of the tree.
 * Return: The extracted node value, else NULL.
 */
