...
/**
 * find_node - A node with a given value is found.
...
/**
 * replace_with_successor - A node with its inorder/successor is replaced
 * @node: Points to the node in search tree.
 * Return: Points to the inorder/successor node of the node.
 */
...
/**
 * bst_remove - A node with a given value is removed.
 * @root: The actual binary search tree.
 * @value: The actual value of the node.
 * Return: PointS to the root node of the tree, or NULL.
 */
